...
How to use:
python collector.py --start 710229426 --end 728819142 --path ../data/201602
'''
import os
import os.path
import time
...
api_client = RiotWatcher(key=config.API_KEY, default_region=BRAZIL)
...
def collect(start, end, path=config.DUMP_DIR, criterion=config.MATCH_FILTER, n=10000):
    collected = []
